...
!BOP
! !ROUTINE: jules5x_descale_ldtsi
! \label{jules5x_descale_ldtsi}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_descale_ldtsi(n, LSM_State, LSM_Incr_State)
...
!  \end{description}
!EOP
end subroutine jules5x_descale_ldtsi
