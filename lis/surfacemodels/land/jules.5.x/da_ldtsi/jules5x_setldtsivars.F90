...
!BOP
! !ROUTINE: jules5x_setldtsivars
! \label{jules5x_setldtsivars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_setldtsivars(n, LSM_State)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     call jules5x_ldtsi_update(n, t, dsneqv, dsnowh)

  enddo
  
end subroutine jules5x_setldtsivars
