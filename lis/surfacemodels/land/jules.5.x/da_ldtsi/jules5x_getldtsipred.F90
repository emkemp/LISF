...
!BOP
! !ROUTINE: jules5x_getldtsipred
! \label{jules5x_getldtsipred}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_getldtsipred(n, k, obs_pred)
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     snwd(t) = jules5x_struc(n)%jules5x(t)%snowdepth(pft) ! unit: m
  enddo
...
end subroutine jules5x_getldtsipred
