...
!BOP
! !ROUTINE: jules5x_ldtsi_update
! \label{jules5x_ldtsi_update}
!
! !REVISION HISTORY:
! 18 Jun 2019: Yeosang Yoon; Initial specification
! 08 Jul 2019: Yeosang Yoon; Modified for Jules.5.0 and LDT-SI data
! 29 Jul 2019: Eric Kemp; Modified to Jules 5.x container
!
! !INTERFACE

subroutine jules5x_ldtsi_update(n, t, dsneqv, dsnowh)
...
end subroutine jules5x_ldtsi_update
