...
!BOP
! !ROUTINE: jules5x_descale_snodep
! \label{jules5x_descale_snodep}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_descale_snodep(n, LSM_State, LSM_Incr_State)
...
!  \end{description}
!EOP
end subroutine jules5x_descale_snodep
