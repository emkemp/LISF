...
!BOP
! !ROUTINE: jules5x_setsnodepvars
! \label{jules5x_setsnodepvars}
!
! !REVISION HISTORY:
...
!
! !INTERFACE:
subroutine jules5x_setsnodepvars(n, LSM_State)
! !USES:
  use ESMF
...
!EOP
  ...
  do t=1,LIS_rc%npatch(n,LIS_rc%lsm_index)
     ...
     call jules5x_snodep_update(n, t, dsneqv, dsnowh)

  enddo
  
end subroutine jules5x_setsnodepvars
